"""
Unit 4 V2: Feature Selection and Model Training (with m5 Feature Engineering)
Reads from BigQuery, applies m5 feature engineering, pre-filters, tests imbalance strategies, trains final models
"""
import json
import os
import math
...
def main():
    ...
    print("=" * 80)
    print("Unit 4 V2: Feature Selection and Model Training")
    print("=" * 80)
    print()
    ...
    print(f"[7/13] Running cross-validation with pre-filtering and strategy testing...", flush=True)
    ...
    print(f"[9/13] Applying pre-filters on full dataset...", flush=True)
    ...
    joblib.dump(final_model, ARTIFACTS_DIR / "model_v2.pkl")
    joblib.dump(baseline_model, ARTIFACTS_DIR / "model_v2_baseline_logit.pkl")
    
    # Save CV fold indices
    with open(ARTIFACTS_DIR / "cv_fold_indices_v2.json", "w", encoding="utf-8") as f:
        json.dump(cv_indices, f, indent=2)
    
    # Save selected features
    with open(ARTIFACTS_DIR / "selected_features_v2.json", "w", encoding="utf-8") as f:
    ...
    importance_df.to_csv(ARTIFACTS_DIR / "feature_importance_v2.csv", index=False)
    ...
    with open(ARTIFACTS_DIR / "feature_selection_report_v2.md", "w", encoding="utf-8") as f:
    ...
    with open(ARTIFACTS_DIR / "model_training_report_v2.md", "w", encoding="utf-8") as f:
    ...
    print()
    print("=" * 80)
    print("Unit 4 V2 Training Complete!")
    print("=" * 80)
    print()
    print("Artifacts created:")
    print(f"  ✓ model_v2.pkl")
    print(f"  ✓ model_v2_baseline_logit.pkl")
    print(f"  ✓ cv_fold_indices_v2.json")
    print(f"  ✓ feature_importance_v2.csv")
    print(f"  ✓ feature_selection_report_v2.md")
    print(f"  ✓ model_training_report_v2.md")
    print(f"  ✓ selected_features_v2.json")
    print()
