...
- **Test AUC-ROC:** 0.5844
- **CV Mean AUC-PR:** 0.0628 (6.28%) if cv_scores else 'N/A'
- **CV Stability:** 10.98% coefficient of variation if cv_scores and np.mean(cv_scores) > 0 else 'N/A'
...
| **AUC-ROC** | 0.5844 | ⚠️ Needs Improvement |
...
- **Mean:** 0.0628 (6.28%)
- **Std Dev:** 0.0069
- **Coefficient of Variation:** 10.98%
- **Stability:** ✅ Excellent
...
| **Train AUC-PR** | 0.1032 | - |
| **Test AUC-PR** | 0.0597 | - |
| **Overfit Gap (pp)** | 4.35pp | ✅ Low |
| **Overfit Gap (%)** | 42.1% | ⚠️ Moderate |
...
|------|---------|------------|--------|------|
| 1 | `Firm_Stability_Score_v12_binned_Low_Unde` | 0.1357 | 13.57% | Tenure/Stability |
| 2 | `Gender_Missing` | 0.1002 | 10.02% | Other |
| 3 | `Number_YearsPriorFirm1_binned_Long_7_Plu` | 0.0891 | 8.91% | Tenure/Stability |
| 4 | `Firm_Stability_Score_v12_binned_Very_Hig` | 0.0778 | 7.78% | Tenure/Stability |
| 5 | `AverageTenureAtPriorFirms_binned_Very_Lo` | 0.0512 | 5.12% | Tenure/Stability |
| 6 | `AverageTenureAtPriorFirms_binned_Long_5_` | 0.0499 | 4.99% | Tenure/Stability |
| 7 | `AverageTenureAtPriorFirms_binned_Moderat` | 0.0464 | 4.64% | Tenure/Stability |
| 8 | `Number_YearsPriorFirm3` | 0.0448 | 4.48% | Tenure/Stability |
| 9 | `Number_YearsPriorFirm2` | 0.0443 | 4.43% | Tenure/Stability |
| 10 | `Firm_Stability_Score_v12_binned_Moderate` | 0.0441 | 4.41% | Tenure/Stability |
| 11 | `Firm_Stability_Score_v12_binned_High_60_` | 0.0438 | 4.38% | Tenure/Stability |
| 12 | `Number_YearsPriorFirm4` | 0.0438 | 4.38% | Tenure/Stability |
| 13 | `Number_YearsPriorFirm1_binned_Short_Unde` | 0.0434 | 4.34% | Tenure/Stability |
| 14 | `Gender_Male` | 0.0407 | 4.07% | Other |
| 15 | `RegulatoryDisclosures_Yes` | 0.0379 | 3.79% | Other |
| 16 | `RegulatoryDisclosures_Unknown` | 0.0359 | 3.59% | Other |
| 17 | `AverageTenureAtPriorFirms_binned_Short_U` | 0.0359 | 3.59% | Tenure/Stability |
| 18 | `Number_YearsPriorFirm1_binned_Moderate_3` | 0.0349 | 3.49% | Tenure/Stability |
| 19 | `AssetsInMillions_Equity_ExchangeTraded` | 0.0000 | 0.00% | Financial |
| 20 | `AssetsInMillions_PrivateFunds` | 0.0000 | 0.00% | Financial |
...
|------------|----------------|-------|------|-----------------|------|
| Top 1% | 0.7714 | 455 | 31 | 6.81% | 1.44x |
| Top 5% | 0.7518 | 477 | 33 | 6.92% | 1.46x |
| Top 10% | 0.6833 | 933 | 58 | 6.22% | 1.31x |
| Top 20% | 0.6287 | 1865 | 112 | 6.01% | 1.27x |
| Top 30% | 0.5813 | 2811 | 181 | 6.44% | 1.36x |
| Top 50% | 0.4640 | 4781 | 287 | 6.00% | 1.27x |
...
**Report Generated:** 2025-11-05 17:06:43  
