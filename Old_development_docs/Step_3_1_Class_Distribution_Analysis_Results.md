# Step 3.1: Class Distribution Analysis (30-day window focus)

## Overall Metrics

- **Total contacted leads**: 49,805
- **All-time conversions**: 2,168 (4.35%)
- **30-day conversions**: 1,954 (3.92%)
- **Class imbalance (neg:pos within 30d)**: 24.49 : 1

## Discovery Data Coverage

- **Contacted leads**: 51,234
- **With CRD**: 47,681
- **Matched to discovery**: 45,249
- **CRD match rate**: 94.90%

## AUM Tier Performance (Lead.Total_Firm_AUM__c)

Note: AUM on the Lead object is sparsely populated; most records are in "Unknown".

| AUM Tier   | Leads | 30d Conversions | 30d Conv Rate |
|------------|-------|-----------------|---------------|
| <$100M     | 243   | 32              | 13.17%        |
| $100-500M  | 34    | 30              | 88.24%        |
| >$500M     | 35    | 29              | 82.86%        |
| Unknown    | 49,493| 1,863           | 3.76%         |

## Metro Area Performance (from discovery reps home metro)

| Metro  | Leads | 30d Conversions | 30d Conv Rate |
|--------|-------|-----------------|---------------|
| NYC    | 1,854 | 49              | 2.64%         |
| LA     | 1,167 | 28              | 2.40%         |
| Chicago| 865   | 31              | 3.58%         |
| Dallas | 1,031 | 31              | 3.01%         |
| Miami  | 623   | 9               | 1.44%         |
| Other  | 45,694| 1,858           | 4.07%         |

## Temporal Patterns (by day of week of Contacted)

1=Sunday … 7=Saturday. Weekend flag shown for convenience.

| DOW | Weekend | Leads | 30d Conversions | 30d Conv Rate |
|-----|---------|-------|-----------------|---------------|
| 1   | 1       | 244   | 12              | 4.92%         |
| 2   | 0       | 6,381 | 259             | 4.06%         |
| 3   | 0       | 12,528| 491             | 3.92%         |
...
- AUM tier results are dominated by "Unknown"; the extremely high rates in populated tiers likely reflect small-N bias. We will revisit with engineered features once `discovery_reps_with_features` is available.
- Metro performance aligns with prior finding that large metros underperform relative to Other.
- Weekend contacts (especially Sunday) show higher conversion rates, consistent with earlier observations.
